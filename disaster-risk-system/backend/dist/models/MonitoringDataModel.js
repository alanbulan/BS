...
exports.MonitoringDataModel = void 0;
const BaseModel_1 = require("./BaseModel");
class MonitoringDataModel extends BaseModel_1.BaseModel {
    constructor() {
    ...
    async getLatestDataByStation(stationId, dataType, limit = 10) {
        try {
            let sql = `
    ...
    async getDataByTimeRange(stationId, dataType, timeRange, limit) {
        try {
            let sql = `
        SELECT md.*, ms.name as station_name, ms.station_type
        FROM monitoring_data md
    ...
    async getDataStatistics(stationId, dataType, hours = 24) {
        try {
            const sql = `
        SELECT 
          COUNT(*) as data_count,
    ...
    async getAnomalousData(stationId, hours = 24) {
        try {
            let sql = `
        SELECT md.*, ms.name as station_name, ms.station_type
        FROM monitoring_data md
    ...
    async getDataTrend(stationId, dataType, hours = 24, interval = '1 hour') {
        try {
            const sql = `
        SELECT 
    ...
    async getMultiStationData(stationIds, dataType, hours = 24) {
    ...
    async deleteExpiredData(daysToKeep = 90) {
        try {
            const sql = `
    ...
    async getDataQualityReport(stationId, hours = 24) {
        try {
            let sql = `
        SELECT 
          data_type,
    ...
    async getRealTimeData(stationIds, dataTypes, limit = 100) {
        try {
            let sql = `
...
exports.MonitoringDataModel = MonitoringDataModel;
//# sourceMappingURL=MonitoringDataModel.js.map